...
plt.text(1.4, -1.0, 'RMSE = ', c='r', fontsize=20)
plt.text(2.25, -1.0, error_rmse, c='r', fontsize=20)
plt.text(2.7, -1.0, 'eV', c='r', fontsize=20)
...
plt.title('(+1/0) Transition Level', c='k', fontsize=32)
