...
plt.subplots_adjust(left=0.17, bottom=0.19, right=0.95, top=0.88)
...
#plt.text(1.2, -1.0, 'Error_rmse = ', c='r', fontsize=16)
#plt.text(2.3, -1.0, error_rmse, c='r', fontsize=16)
#plt.text(2.7, -1.0, 'eV', c='r', fontsize=16)


plt.text(4.5, 0.4, 'RMSE = ', c='r', fontsize=20)
plt.text(6.2, 0.4, error_rmse, c='r', fontsize=20)
plt.text(6.9, 0.4, 'eV', c='r', fontsize=20)
...
plt.title('Formation Energy (X-rich)', c='k', fontsize=32)
...
#plt.plot(b, a, c='k', ls='--')
#plt.plot(b, c, c='k', ls='--')
plt.savefig('plot_form_X_rich.eps', dpi=450)
##plt.show()
