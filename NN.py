...
ax5.text(4.32, 0.65, 'Test_rmse = ', c='r', fontsize=12)
ax5.text(6.8, 0.65, te, c='r', fontsize=12)
ax5.text(7.67, 0.65, 'eV', c='r', fontsize=12)
ax5.text(4.19, -0.18, 'Train_rmse = ', c='r', fontsize=12)
ax5.text(6.8, -0.18, tr, c='r', fontsize=12)
