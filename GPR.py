...
Pred_train_fl = gpr_opt.predict(X_train_fl)
Pred_test_fl  = gpr_opt.predict(X_test_fl)
...
ax1.text(-0.10, -1.97, 'Train_rmse = ', color='r', fontsize=12)
ax1.text(1.02, -1.97, tr, color='r', fontsize=12)
ax1.text(1.43, -1.97, 'eV', color='r', fontsize=12)
ax1.text(-0.05, -1.62, 'Test_rmse = ', color='r', fontsize=12)
ax1.text(1.02, -1.62, te, color='r', fontsize=12)
ax1.text(1.43, -1.62, 'eV', color='r', fontsize=12)
...
ax1.set_title('(+2/+1) Transition Level', color='k', fontsize=20, pad=10)
...
ax2.text(1.05, -1.1, 'Train_rmse = ', color='r', fontsize=12)
ax2.text(2.35, -1.1, tr, color='r', fontsize=12)
ax2.text(2.82, -1.1, 'eV', color='r', fontsize=12)
ax2.text(1.10, -0.68, 'Test_rmse = ', color='r', fontsize=12)
ax2.text(2.35, -0.68, te, color='r', fontsize=12)
ax2.text(2.82, -0.68, 'eV', color='r', fontsize=12)
...
ax2.set_title('(+1/0) Transition Level', color='k', fontsize=20, pad=10)
...
ax3.text(1.86, 0.22, 'Test_rmse = ', color='r', fontsize=12)
ax3.text(3.01, 0.22, te, color='r', fontsize=12)
ax3.text(3.45, 0.22, 'eV', color='r', fontsize=12)
ax3.text(1.81, -0.15, 'Train_rmse = ', color='r', fontsize=12)
ax3.text(3.01, -0.15, tr, color='r', fontsize=12)
ax3.text(3.45, -0.15, 'eV', color='r', fontsize=12)
...
ax3.set_title('(0/-1) Transition Level', color='k', fontsize=20, pad=10)
...
ax4.text(2.52, 0.92, 'Test_rmse = ', color='r', fontsize=12)
ax4.text(3.68, 0.92, te, color='r', fontsize=12)
ax4.text(4.11, 0.92, 'eV', color='r', fontsize=12)
ax4.text(2.47, 0.55, 'Train_rmse = ', color='r', fontsize=12)
ax4.text(3.68, 0.55, tr, color='r', fontsize=12)
ax4.text(4.11, 0.55, 'eV', color='r', fontsize=12)
...
ax4.set_title('(-1/-2) Transition Level', color='k', fontsize=20, pad=10)
...
ax5.text(4.32, 0.65, 'Test_rmse = ', color='r', fontsize=12)
ax5.text(6.8, 0.65, te, color='r', fontsize=12)
ax5.text(7.67, 0.65, 'eV', color='r', fontsize=12)
ax5.text(4.19, -0.18, 'Train_rmse = ', color='r', fontsize=12)
ax5.text(6.8, -0.18, tr, color='r', fontsize=12)
ax5.text(7.67, -0.18, 'eV', color='r', fontsize=12)

ax5.set_xticks([0, 2, 4, 6, 8])
ax5.set_yticks([0, 2, 4, 6, 8])

ax5.set_title('Formation Energy (X-rich)', color='k', fontsize=20, pad=10)
...
ax6.text(4.60, 0.75, 'Test_rmse = ', color='r', fontsize=12)
ax6.text(7.2, 0.75, te, color='r', fontsize=12)
ax6.text(8.15, 0.75, 'eV', color='r', fontsize=12)
ax6.text(4.48, -0.1, 'Train_rmse = ', color='r', fontsize=12)
ax6.text(7.2, -0.1, tr, color='r', fontsize=12)
ax6.text(8.15, -0.1, 'eV', color='r', fontsize=12)

ax6.set_xticks([0, 2, 4, 6, 8])
ax6.set_yticks([0, 2, 4, 6, 8])

ax6.set_title('Formation Energy (Pb-rich)', color='k', fontsize=20, pad=10)
